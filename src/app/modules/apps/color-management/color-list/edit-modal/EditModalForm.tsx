...
import { updateColor,createColor} from '../core/_requests'
    ...
    onSubmit: async (values, {setSubmitting}) => {
      ...
      try {
        if (isNotEmpty(values.id)) {
          ...
          await  updateColor(dataToSend,values.id)
    ...
    <>
      <form id='kt_modal_add_user_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        ...
        >
          ...
          <div className='fv-row mb-7'>
          <Input type='color'  name='code'  formik={formik} label='Couleur' isUserLoading={isUserLoading} isRequired={true} />   
