...
import { updateEvent,createEvent} from '../core/_requests'
    ...
    onSubmit: async (values, {setSubmitting}) => {
      ...
      try {
        if (isNotEmpty(values.id)) {
          ...
          await  updateEvent(dataToSend,values.id)
    ...
    <>
      <form id='kt_modal_add_user_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        ...
        >
          ...
          <div className='fv-row mb-7'>
          <Input type='date'  name='date' formik={formik} label='Date' isUserLoading={isUserLoading} isRequired={true} />   
